      ...
      <main id="main-content" class="pt-16 px-6 pb-8">
        ...
        <section class="mb-8">
          <div class="flex items-center justify-between mb-4">
            <h2 class="text-xl font-bold text-gray-800">Input Narkotika</h2>
        ...
        <section class="bg-white rounded-lg border border-gray-200 shadow-md overflow-hidden">
          ...
          <section class="mt-8 mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <a href="../narkotika/export_excel.php" class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition data-card flex flex-col items-center justify-center text-center">
