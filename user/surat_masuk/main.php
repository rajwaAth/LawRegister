...
<head>
  ...
  <title>LawRegister - Surat Masuk</title>
  ...
  <div class="flex h-screen bg-gray-100">
    <aside id="sidebar" class="transition-transform duration-300 transform translate-x-0 flex flex-col bg-white text-gray-700 h-screen fixed top-0 left-0 z-40 border-r border-gray-200 shadow-lg w-64">
      ...
      <nav class="flex-1 px-2 py-6 space-y-1 overflow-y-auto">
        ...
        <a href="../surat_masuk/main.php" class="flex items-center gap-3 py-2.5 px-4 rounded-lg active-menu hover:bg-blue-500 hover:text-white transition-all">
          <i class="fas fa-envelope menu-icon text-lg"></i><span class="menu-label">Surat Masuk</span>
        </a>

        <p class="px-4 text-xs font-semibold text-gray-500 uppercase tracking-wider mt-6 menu-label">Jenis Surat</p>
        <a href="../oharda/oharda.php" class="flex items-center gap-3 py-2.5 px-4 rounded-lg hover:bg-gray-100 transition-all">
          <i class="fas fa-money-bill-wave menu-icon text-lg"></i><span class="menu-label">Orharda</span>
        </a>
        <a href="../kemnegtibum/kemnegtibum.php" class="flex items-center gap-3 py-2.5 px-4 rounded-lg hover:bg-gray-100 transition-all">
          <i class="fas fa-shield-alt menu-icon text-lg"></i><span class="menu-label">Kemnegtibum</span>
        </a>
        <a href="../narkotika/narkotika.php" class="flex items-center gap-3 py-2.5 px-4 rounded-lg hover:bg-gray-100 transition-all">
          <i class="fas fa-pills menu-icon text-lg"></i><span class="menu-label">Narkotika</span>
        </a>
      </nav>
    </aside>
      ...
      <header class="fixed top-0 left-0 right-0 bg-white border-b border-gray-200 shadow-sm z-30 ml-0 md:ml-64 transition-all duration-300" id="main-header">
        <div class="flex justify-between items-center px-6 py-3">
          <div class="flex items-center gap-3">
            ...
            <div class="text-lg font-semibold text-gray-800">Surat Masuk</div>
          </div>
