...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (mysqli_query($mysqli, $query)) {
    echo "<script>alert('Data berhasil diupdate!'); window.location.href = 'surat_masuk.php';</script>";
    exit;
  } else {
  ...
  <div class="max-w-3xl w-full bg-white p-8 rounded-xl shadow-lg border border-blue-200">
    ...
    <form method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div>
        ...
        <select name="keterangan" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300">
      ...
      <div class="md:col-span-2 text-right">
        ...
        <a href="surat_masuk.php" class="ml-2 text-blue-500 hover:underline">Kembali</a>
      </div>
    </form>
  </div>
</body>
