    ...
    <div class="flex-1 transition-all duration-300 ml-0 md:ml-64" id="main-wrapper">
      ...
      <main id="main-content" class="pt-16 px-6 pb-8">
        <section class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-5 data-card">
            <div class="flex justify-between items-start">
              <div>
                <p class="text-sm font-medium text-gray-500">Total Surat</p>
                <h3 class="text-2xl font-bold mt-1"><?php echo $total_surat; ?></h3>
              </div>
          ...
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-5 data-card">
            <div class="flex justify-between items-start">
              <div>
                <p class="text-sm font-medium text-gray-500">Telah di-ACC</p>
                <h3 class="text-2xl font-bold mt-1"><?php echo $total_acc; ?></h3>
              </div>
          ...
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-5 data-card">
            <div class="flex justify-between items-start">
              <div>
                <p class="text-sm font-medium text-gray-500">Belum di-ACC</p>
                <h3 class="text-2xl font-bold mt-1"><?php echo $total_pending; ?></h3>
              </div>
        ...
        <section class="mb-8">
          <div class="flex items-center justify-between mb-4">
            <h2 class="text-xl font-bold text-gray-800">Input Surat Masuk</h2>
          ...
          <form id="inputForm" action="create.php" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-5 bg-white p-6 rounded-lg border border-gray-200 shadow-sm mb-8 hidden">
            <div>
              ...
              <div class="relative">
                ...
                <input type="date" name="tanggal" class="pl-10 w-full border border-gray-300 rounded-lg p-2.5 text-sm focus:ring-blue-500 focus:border-blue-500" required>
              </div>
            </div>
            <div>
              <label class="block mb-2 text-sm font-medium text-gray-700">No. & Tgl. Masuk</label>
              <div class="relative">
                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <i class="fas fa-hashtag text-gray-400"></i>
                </div>
                <input type="text" name="no_tgl_masuk" class="pl-10 w-full border border-gray-300 rounded-lg p-2.5 text-sm" placeholder="Nomor dan Tanggal Masuk" required>
              </div>
            </div>
            <div>
              <label class="block mb-2 text-sm font-medium text-gray-700">Asal Surat</label>
              <div class="relative">
                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <i class="far fa-building text-gray-400"></i>
                </div>
                <input type="text" name="asal_surat" class="pl-10 w-full border border-gray-300 rounded-lg p-2.5 text-sm" placeholder="Asal Surat" required>
              </div>
            </div>
            <div>
              <label class="block mb-2 text-sm font-medium text-gray-700">Disposisi</label>
              <div class="relative">
                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <i class="fas fa-share text-gray-400"></i>
                </div>
                <input type="text" name="disposisi" class="pl-10 w-full border border-gray-300 rounded-lg p-2.5 text-sm" placeholder="Disposisi" required>
              </div>
            </div>
            <div class="md:col-span-2">
              <label class="block mb-2 text-sm font-medium text-gray-700">Isi Surat</label>
              <div class="relative">
                <div class="absolute top-3 left-3 pointer-events-none">
                  <i class="far fa-file-alt text-gray-400"></i>
                </div>
                <textarea name="isi_surat" rows="3" class="pl-10 w-full border border-gray-300 rounded-lg p-2.5 text-sm" placeholder="Isi Surat" required></textarea>
              </div>
            </div>
            <div>
            ...
            <div class="md:col-span-2 flex justify-end gap-3 mt-2">
              ...
              <button type="submit" class="btn-primary bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 transition text-sm font-medium">
          ...
          <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="search-container flex-grow max-w-md">
              <div class="relative">
                ...
                <input type="text" id="searchInput" onkeyup="searchTable()" placeholder="Cari berdasarkan asal surat atau isi..." class="w-full p-2.5 pl-10 border border-gray-300 rounded-lg text-sm" />
              </div>
            </div>
        ...
        <section class="bg-white rounded-lg border border-gray-200 shadow-md overflow-hidden">
            ...
            <table class="w-full text-sm text-left text-gray-700" id="dataTable">
              <thead class="text-xs text-gray-700 uppercase bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th class="px-5 py-3.5">No. & Tgl. Masuk</th>
                  <th class="px-5 py-3.5">Asal Surat</th>
                  <th class="px-5 py-3.5">Isi Surat</th>
                  <th class="px-5 py-3.5">Disposisi</th>
              ...
              <tbody class="divide-y divide-gray-200" id="tableBody">
                ...
                ?>
                  <tr class="hover:bg-gray-50 data-status-<?php echo $keterangan === 'belum di acc' ? 'belum' : 'acc'; ?>">
                    <td class="px-5 py-4 whitespace-nowrap"><?php echo $row['tanggal']; ?></td>
                    <td class="px-5 py-4"><?php echo $row['no_tgl_masuk']; ?></td>
                    <td class="px-5 py-4"><?php echo $row['asal_surat']; ?></td>
                    <td class="px-5 py-4 max-w-xs truncate"><?php echo $row['isi_surat']; ?></td>
                    <td class="px-5 py-4">
                      <span class="inline-flex items-center px-2.5 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-xl border border-blue-200">
                        <?php echo $row['disposisi']; ?>
                      </span>
                    </td>
                    <td class="px-5 py-4">
                      <span class="inline-flex items-center px-2.5 py-1 text-xs font-medium <?php echo $warna_keterangan; ?> rounded-xl">
                ...
                <?php
                  ...
                  echo "<tr><td colspan='7' class='px-5 py-4 text-center text-gray-500'>Tidak ada data surat masuk.</td></tr>";
                }
                ?>
              </tbody>
            </table>
          ...
          <div class="sm:hidden" id="mobileCards">
            ...
            ?>
              <div class="border-b border-gray-200 p-4 data-card data-status-<?php echo $keterangan === 'belum di acc' ? 'belum' : 'acc'; ?>">
                <div class="flex justify-between items-start mb-3">
                  <div>
                    <p class="font-semibold text-gray-800"><?php echo $row['asal_surat']; ?></p>
                    <p class="text-xs text-gray-500 mt-1"><?php echo $row['tanggal']; ?> · <?php echo $row['no_tgl_masuk']; ?></p>
                  </div>
                  <span class="inline-flex items-center px-2.5 py-1 text-xs font-medium <?php echo $warna_keterangan; ?> rounded-full">
                    <?php echo $status_icon . $row['keterangan']; ?>
                  </span>
                </div>
                <p class="text-sm mb-3 text-gray-700 border-l-2 border-blue-300 pl-3"><?php echo $row['isi_surat']; ?></p>
                <div class="flex items-center justify-between">
                  <span class="inline-flex items-center px-2.5 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full border border-blue-200">
                    <?php echo $row['disposisi']; ?>
                  </span>
                  <div class="flex gap-3">
            ...
            <?php
              ...
              echo "<div class='py-6 px-4 text-center text-gray-500'>Tidak ada data surat masuk.</div>";
            }
            ?>
          </div>
          ...
          <section class="mt-8 mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <a href="#" class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition data-card flex flex-col items-center justify-center text-center">
                ...
                <h3 class="font-medium text-gray-800">Print Report</h3>
                <p class="text-xs text-gray-500 mt-1">Generate PDF report</p>
              </a>

              <a href="../surat_masuk/export_excel.php" class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition data-card flex flex-col items-center justify-center text-center">
                ...
                <h3 class="font-medium text-gray-800">Export to Excel</h3>
                <p class="text-xs text-gray-500 mt-1">Download as spreadsheet</p>
              </a>
          </section>
      </main>
...
<script>
  ...
  function searchTable() {
    ...
    document.querySelectorAll('#tableBody tr').forEach(row => {
      ...
      const isi = row.children[3]?.textContent.toLowerCase() || "";
  ...
  function filterByDate() {
    ...
    document.querySelectorAll('#tableBody tr').forEach(row => {
      const rowDate = row.cells[0].textContent.trim(); // Mengambil tanggal dari kolom kedua (Tgl. Nomor)
